...
| 0.5 | 04/09/2026 | Lissage étendu aux jours **blancs** (références = jours bleus uniquement) ; tableau récapitulatif par jour en fin d'écran principal (§4.2.5) |
...
4. permet, pour Tempo, de « lisser » la consommation des jours blancs et rouges afin de simuler un comportement sans effacement.
