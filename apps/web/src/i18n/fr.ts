...
export const t = {
  ...
  home: {
    ...
    days: {
      ...
      description:
        'Un jour Tempo va de 06:00 à 06:00 le lendemain ; HP / HC selon les créneaux de l’option Tempo. Le lissage ne fait que relever les jours blancs et rouges sous le profil des jours bleus ; les jours sans consommation (index figé) ne sont pas lissés.',
      date: 'Jour',
      color: 'Couleur',
      total: 'Total',
      hp: 'HP',
